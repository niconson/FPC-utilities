...
try     {
        ...
        {
        ShowMessage("    Œ¯Ë·Í‡ ‚˚‰ÂÎÂÌËˇ Ô‡ÏˇÚË: bool[" + AnsiString(CPins) + "]!" );
        exit(0);
        }
try     {
        ...
        {
        ShowMessage("    Œ¯Ë·Í‡ ‚˚‰ÂÎÂÌËˇ Ô‡ÏˇÚË: double[" + AnsiString(CPins) + "]!" );
        exit(0);
        }
try     {
...
try     {
        ...
        {
        ShowMessage("    Œ¯Ë·Í‡ ‚˚‰ÂÎÂÌËˇ Ô‡ÏˇÚË: long[" + AnsiString((CFile - index_NETS)/3) + "]!" );
        exit(0);
        }
try     {
...
if (A3.SubString(1,6) == "corner" && A4.SubString(1,4) == "area")
        ...
        try     {
                ...
                {
                ShowMessage("    Œ¯Ë·Í‡ ‚˚‰ÂÎÂÌËˇ Ô‡ÏˇÚË: area[" + AnsiString(CountCorners+1) + "]!" );
                exit(0);
                }
        bool EnableFlag;
        bool EndFlag = false;
...
WR.close();
//------------------------------------------------
//   ÍÓÂÍˆËˇ Á‡„ÓÎÓ‚ÍÓ‚ Ú‡ÒÒ Ë ÔÓÎË„ÓÌÓ‚
//------------------------------------------------
...
long C_seg = 0;      //ÍÓÎ ‚Ó ÒÂ„ÏÂÌÚÓ‚
long n_str = 0;      //ÌÓÏÂ ÒÚÓÍË
bool FLAG_net = false;
while (1)
        {
