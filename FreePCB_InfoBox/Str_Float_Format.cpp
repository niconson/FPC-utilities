...
for (int x=1; x<=L; x++)
        {
        if (STRING_2_DOUBLE.SubString(1,1) == "-")
                continue;
...
if  (((STRING_2_DOUBLE.SubString(1,1) == "-")&&(L<2))||(!L))
        return 0;
if  (STRING_2_DOUBLE.SubString(1,1) == ",")
        STRING_2_DOUBLE = "0" + STRING_2_DOUBLE;
if  (STRING_2_DOUBLE.SubString(L,1) == ",")
        STRING_2_DOUBLE = STRING_2_DOUBLE + "0";
