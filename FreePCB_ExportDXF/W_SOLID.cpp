...
void W_SOLID (  float x1,
        ...
        Form1->OutputBox->Items->Add("3DFACE");
        ...
        Form1->OutputBox->Items->Add(F_str(x1));
        Form1->OutputBox->Items->Add("20");
        Form1->OutputBox->Items->Add(F_str(y1));
        Form1->OutputBox->Items->Add("30");
        Form1->OutputBox->Items->Add(F_str(z1));
        //
        Form1->OutputBox->Items->Add("11");
        Form1->OutputBox->Items->Add(F_str(x2));
        Form1->OutputBox->Items->Add("21");
        Form1->OutputBox->Items->Add(F_str(y2));
        Form1->OutputBox->Items->Add("31");
        Form1->OutputBox->Items->Add(F_str(z2));
        //
        Form1->OutputBox->Items->Add("12");
        Form1->OutputBox->Items->Add(F_str(x4));
        Form1->OutputBox->Items->Add("22");
        Form1->OutputBox->Items->Add(F_str(y4));
        Form1->OutputBox->Items->Add("32");
        Form1->OutputBox->Items->Add(F_str(z4));
        //
        Form1->OutputBox->Items->Add("13");
        Form1->OutputBox->Items->Add(F_str(x3));
        Form1->OutputBox->Items->Add("23");
        Form1->OutputBox->Items->Add(F_str(y3));
        Form1->OutputBox->Items->Add("33");
        Form1->OutputBox->Items->Add(F_str(z3));
        }