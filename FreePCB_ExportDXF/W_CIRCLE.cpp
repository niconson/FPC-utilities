...
void W_CIRCLE ( float x,
        ...
        Form1->OutputBox->Items->Add("CIRCLE");
        ...
        Form1->OutputBox->Items->Add(F_str(x));
        Form1->OutputBox->Items->Add("20");
        Form1->OutputBox->Items->Add(F_str(y));
        Form1->OutputBox->Items->Add("40");
        Form1->OutputBox->Items->Add(F_str(R));
        }